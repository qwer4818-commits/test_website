...
type ReviewRequest = { place: string; nonce: number };
...
export default function ReviewsSection({
  ...
  placeNames: string[];
  localReviews: Review[];
  onChangeLocal: (next: Review[]) => void;
  ...
  useEffect(() => {
    // A recommend card asked to review a specific place: preselect it.
    if (reviewRequest.place) {
      // eslint-disable-next-line react-hooks/set-state-in-effect
      setPlaceName(reviewRequest.place);
    }
  }, [reviewRequest]);
